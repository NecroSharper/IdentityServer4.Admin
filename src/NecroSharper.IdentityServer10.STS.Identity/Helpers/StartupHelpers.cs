...
using NecroSharper.IdentityServer10.STS.Identity.Configuration;
using NecroSharper.IdentityServer10.STS.Identity.Configuration.ApplicationParts;
using NecroSharper.IdentityServer10.STS.Identity.Configuration.Constants;
using NecroSharper.IdentityServer10.STS.Identity.Configuration.Interfaces;
using NecroSharper.IdentityServer10.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace NecroSharper.IdentityServer10.STS.Identity.Helpers
{
