...
using NecroSharper.IdentityServer10.Shared.Configuration.Configuration.Email;
using NecroSharper.IdentityServer10.Shared.Configuration.Email;

namespace NecroSharper.IdentityServer10.Shared.Configuration.Helpers
{
    public static class StartupHelpers
    {
            ...
            where TDbContext : DbContext, IDataProtectionKeyContext
        {
            var dataProtectionBuilder = services.AddDataProtection()
                .SetApplicationName("NecroSharper.IdentityServer10")
