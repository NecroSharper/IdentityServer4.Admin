...
using NecroSharper.IdentityServer10.Admin.BusinessLogic.Services;
using NecroSharper.IdentityServer10.Admin.BusinessLogic.Services.Interfaces;
using NecroSharper.IdentityServer10.Admin.UI.Configuration;
using NecroSharper.IdentityServer10.Admin.UI.Configuration.ApplicationParts;
using NecroSharper.IdentityServer10.Admin.UI.Configuration.Constants;
using NecroSharper.IdentityServer10.Admin.EntityFramework.Helpers;
using NecroSharper.IdentityServer10.Admin.EntityFramework.Interfaces;
using NecroSharper.IdentityServer10.Admin.EntityFramework.Repositories;
using NecroSharper.IdentityServer10.Admin.EntityFramework.Repositories.Interfaces;
using NecroSharper.IdentityServer10.Admin.UI.ExceptionHandling;
using NecroSharper.IdentityServer10.Admin.UI.Helpers.Localization;
using System;
...
using NecroSharper.IdentityServer10.Admin.EntityFramework.Configuration.MySql;
using NecroSharper.IdentityServer10.Admin.EntityFramework.Configuration.PostgreSQL;
using NecroSharper.IdentityServer10.Admin.EntityFramework.Configuration.SqlServer;
using NecroSharper.IdentityServer10.Shared.Configuration.Authentication;

namespace NecroSharper.IdentityServer10.Admin.UI.Helpers
{
