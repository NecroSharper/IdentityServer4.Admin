...
namespace NecroSharper.IdentityServer10.Admin.Api.Configuration.Authorization
{
        ...
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            if (hasAuthorize)
            {
                ...
                operation.Security = new List<OpenApiSecurityRequirement>
                {
                    ...
                    {
                        [new OpenApiSecuritySchemeReference("oauth2")] = new List<string> { _adminApiConfiguration.OidcApiName }
                    }
                };
            }
        }
