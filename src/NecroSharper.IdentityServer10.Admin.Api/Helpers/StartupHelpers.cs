...
using NecroSharper.IdentityServer10.Admin.Api.AuditLogging;
using NecroSharper.IdentityServer10.Admin.Api.Configuration;
using NecroSharper.IdentityServer10.Admin.Api.Configuration.ApplicationParts;
using NecroSharper.IdentityServer10.Admin.Api.Configuration.Constants;
using NecroSharper.IdentityServer10.Admin.Api.Helpers.Localization;
...
namespace NecroSharper.IdentityServer10.Admin.Api.Helpers
{
