...
using NecroSharper.IdentityServer10.Admin.BusinessLogic.Dtos.Enums;
using NecroSharper.IdentityServer10.Admin.BusinessLogic.Events.Client;
...
using NecroSharper.IdentityServer10.Admin.BusinessLogic.Resources;
using NecroSharper.IdentityServer10.Admin.BusinessLogic.Services.Interfaces;
using NecroSharper.IdentityServer10.Admin.BusinessLogic.Shared.Dtos.Common;
using NecroSharper.IdentityServer10.Admin.BusinessLogic.Shared.ExceptionHandling;
...
namespace NecroSharper.IdentityServer10.Admin.BusinessLogic.Services
{
